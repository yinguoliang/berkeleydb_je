...
public class StoredEntrySet<K, V> extends StoredCollection<Map.Entry<K, V>> implements Set<Map.Entry<K, V>> {
     ...
     *         previously present). <!-- begin JE only -->
     ...
     * @throws ClassCastException if the mapEntry is not a
     *             {@link java.util.Map.Entry} instance.
     ...
     * operation). This method conforms to the {@link Set#remove} interface.
     *
     ...
     *         the mapEntry is not a {@link java.util.Map.Entry} instance or is
     *         not present in the set. <!-- begin JE only -->
     * @throws OperationFailureException if one of the
     *             <a href="../je/OperationFailureException.html#writeFailures">
     *             Write Operation Failures</a> occurs.
     * @throws EnvironmentFailureException if an unexpected, internal or
     ...
     * conforms to the {@link Set#contains} interface.
     *
     * @param mapEntry is a {@link java.util.Map.Entry} instance to be checked.
     * @return true if the key-value pair is present in the set, or false if the
     *         mapEntry is not a {@link java.util.Map.Entry} instance or is not
     *         present in the set. <!-- begin JE only -->
     * @throws OperationFailureException if one of the
    ...
    Map.Entry<K, V> makeIteratorData(BaseIterator iterator, DatabaseEntry keyEntry, DatabaseEntry priKeyEntry,
                                     DatabaseEntry valueEntry) {

        return new StoredMapEntry(view.makeKey(keyEntry, priKeyEntry), view.makeValue(priKeyEntry, valueEntry), this,
                iterator);
    }
