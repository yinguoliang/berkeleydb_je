 ...
 * directly if a Map is not needed. Although this collection is a set it may
 * contain duplicate values. Only if an entity value binding is used are all
 * elements guaranteed to be unique.
 * <p>
 ...
 * these methods is not compatible with the standard Java collections interface.
 * </p>
 * <ul>
...
public class StoredSortedValueSet<E> extends StoredValueSet<E> implements SortedSet<E> {
     ...
     * strictly less than toValue. This method conforms to the
    ...
    /**
     * Returns a view of the portion of this sorted set whose elements are
     * strictly less than toValue, optionally including toValue. This method
     * does not exist in the standard {@link SortedSet} interface.
     * <p>
     * Note that the return value is a StoredCollection and must be treated as
     * such; for example, its iterators must be explicitly closed.
     * </p>
    ...
    /**
     * Returns a view of the portion of this sorted set whose elements are
     * greater than or equal to fromValue. This method conforms to the
    ...
    /**
     * Returns a view of the portion of this sorted set whose elements are
     * strictly greater than fromValue, optionally including fromValue. This
     ...
     * from fromValue, inclusive, to toValue, exclusive. This method conforms to
     * the {@link SortedSet#subSet} interface.
     * <p>
     * Note that the return value is a StoredCollection and must be treated as
     * such; for example, its iterators must be explicitly closed.
     * </p>
     ...
     * optionally including fromValue and toValue. This method does not exist in
     * the standard {@link SortedSet} interface.
     * <p>
     * Note that the return value is a StoredCollection and must be treated as
     * such; for example, its iterators must be explicitly closed.
     * </p>
    ...
    public SortedSet<E> subSet(E fromValue, boolean fromInclusive, E toValue, boolean toInclusive) {
        try {
            return new StoredSortedValueSet<E>(view.subView(fromValue, fromInclusive, toValue, toInclusive, null));
        } catch (Exception e) {
