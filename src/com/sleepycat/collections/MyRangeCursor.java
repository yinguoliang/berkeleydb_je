...
class MyRangeCursor extends RangeCursor {
     ...
     * cursor config. For CDB, a special cursor must be created for writing. See
     * CurrentTransaction.openCursor.
     */
    ...
    private static Cursor openCursor(DataView view, CursorConfig config, boolean writeAllowed)
        ...
        return view.currentTxn.openCursor(view.db, config, isWriteCursor(config, writeAllowed), view.useTransaction());
    }
