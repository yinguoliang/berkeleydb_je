 ...
 * for changing certain properties of a container. Because container properties
 * are immutable, these methods always return a new container instance. This
 * allows stored container instances to be used safely by multiple threads.
 * Creating the new container instance is not expensive and creates only two new
 * objects.
 * </p>
 * <p>
 * When a container is created with a particular property, all containers and
 * iterators derived from that container will inherit the property. For example,
 * if a read-uncommitted Map is created then calls to its subMap(), values(),
 * entrySet(), and keySet() methods will create read-uncommitted containers
 * also.
 * </p>
 * <p>
 ...
 * isolation, or any other property supported by <code>CursorConfig</code>. All
 * operations performed with the resulting container will be performed with the
 * specified cursor configuration.
 * </p>
 */
public class StoredCollections {
     ...
     *            performed via the new collection instance; null may be
     *            specified to use the default configuration.
     ...
     * <p>
     * Note that this method may not be called in the JE product, since the
     * StoredList class is not supported.
     * </p>
     *
     * @param storedList the base list.
     * @param config is the cursor configuration to be used for all operations
     *            performed via the new list instance; null may be specified to
     ...
     * @param config is the cursor configuration to be used for all operations
     *            performed via the new map instance; null may be specified to
     *            use the default configuration.
     ...
     * @param config is the cursor configuration to be used for all operations
     *            performed via the new set instance; null may be specified to
     *            use the default configuration.
     * @param <E> the element class.
     ...
     *             StoredContainer.
     */
    public static <K, V> SortedMap<K, V> configuredSortedMap(SortedMap<K, V> storedSortedMap, CursorConfig config) {
     ...
     *             StoredContainer.
     */
    public static <E> SortedSet<E> configuredSortedSet(SortedSet<E> storedSortedSet, CursorConfig config) {
