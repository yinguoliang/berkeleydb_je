...
public class TupleOutput extends FastOutputStream {
     ...
     *
     * @param val is the string containing the values to be written. Only
     ...
     * {@link TupleInput#readBytes}.
     *
     * @param chars is the array of values to be written. Only characters with
    ...
    public final TupleOutput writeBigDecimal(BigDecimal val) {
         ...
         * BigDecimal.toByteArray array, written without modification. Get the
         * scale and the unscaled value of this BigDecimal.
         */
        int scale = val.scale();
    ...
    public final TupleOutput writeSortedBigDecimal(BigDecimal val) {
         ...
         * methods and detailed discussion, please refer to [#18379]. First, we
         * need to do the normalization, which means we normalize a given
         * BigDecimal into two parts: decimal part and the exponent part. The
         * decimal part contains one integer (non zero). For example, 1234.56
         * will be normalized to 1.23456E3; 123.4E100 will be normalized to
         * 1.234E102; -123.4E-100 will be normalized to -1.234E-98. After the
         * normalization, the byte format is: Byte 0: sign (-1 represents
         * negative, 0 represents zero, and 1 represents positive). Byte 1 ~ 5:
         * the exponent with sign, and written as a SortedPackedInteger value.
         * Byte 6 ~ N: the normalized decimal part with sign. Get the scale and
