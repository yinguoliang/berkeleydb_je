 ...
 * </p>
 * <p>
 * <a name="evolution"><strong>Class Evolution</strong></a>
 * </p>
 * <p>
 * {@code SerialBinding} and other classes in this package use standard Java
 ...
 * </p>
 * <p>
 * If more advanced class evolution features are required, consider using the
 * {@link com.sleepycat.persist.evolve Direct Persistence Layer}.
 * </p>
 *
 * @author Mark Hayes
 */
public class SerialBinding<E> extends SerialBase implements EntryBinding<E> {
     ...
     *            this binding -- all objects using this binding must be an
     *            instance of this class. Note that if this parameter is
     *            non-null, then this binding will not support serialization of
     *            null values.
     */
     ...
     *             base class for this binding, including if the object is null
     *             and a non-null base class was specified.
     */
        ...
        if (baseClass != null && !baseClass.isInstance(object)) {
            throw new IllegalArgumentException(
                    ((object != null) ? ("Data object class (" + object.getClass() + ')') : "Null value")
                            + " is not an instance of binding's base class (" + baseClass + ')');
        }
