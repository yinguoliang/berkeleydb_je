...
/* <!-- end JE only --> */
{
     ...
     * null if a default class loader should be used. The ClassLoader is used by
     * {@link SerialBinding} to load classes whose description is stored in the
     * catalog.
     * <p>
     * In BDB JE, the implementation of this method in
     * {@link StoredClassCatalog} returns the ClassLoader property of the
     * catalog database Environment. This ensures that the Environment's
