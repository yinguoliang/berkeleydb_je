...
public abstract class SerialSerialKeyCreator<PK, D, SK> implements SecondaryKeyCreator, ForeignKeyNullifier {
     ...
     */
    public SerialSerialKeyCreator(ClassCatalog classCatalog, Class<PK> primaryKeyClass, Class<D> dataClass,
                                  Class<SK> indexKeyClass) {

        this(new SerialBinding<PK>(classCatalog, primaryKeyClass), new SerialBinding<D>(classCatalog, dataClass),
     ...
     */
    public SerialSerialKeyCreator(SerialBinding<PK> primaryKeyBinding, SerialBinding<D> dataBinding,
     ...
     *
     * @param primaryKey is the deserialized source primary key entry, or null
     *            if no primary key entry is used to construct the index key.
     * @param data is the deserialized source data entry, or null if no data
