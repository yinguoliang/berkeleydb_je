...
public class SerialBase {
     ...
     * <p>
     * Unless {@link #setSerialBufferSize} is called, the default
     * {@link FastOutputStream#DEFAULT_INIT_SIZE} size will be used.
     * </p>
     */
    public SerialBase() {
        outputBufferSize = 0;
     ...
     * {@link FastOutputStream#DEFAULT_INIT_SIZE} size is used.
     * </p>
     *
     ...
     * {@link #setSerialBufferSize} method.
     * </p>
     * <p>
     ...
     *            be used by subclasses to determine the size of the output
     *            buffer.
