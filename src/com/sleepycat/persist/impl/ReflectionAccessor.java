...
class ReflectionAccessor implements Accessor {
     ...
     */
    ReflectionAccessor(Catalog catalog, Class type, Accessor superAccessor, FieldInfo priKeyField,
                       List<FieldInfo> secKeyFields, List<FieldInfo> nonKeyFields) {
    ...
    private void setAccessible(AccessibleObject object, String memberName) {
        try {
            ...
            throw new IllegalStateException("Unable to access non-public member: " + type.getName() + '.' + memberName
