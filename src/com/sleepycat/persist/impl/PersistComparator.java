...
/**
 * The btree comparator for persistent key classes. The serialized form of this
 * comparator is stored in the BDB JE database descriptor so that the comparator
 * can be re-created during recovery.
 *
 * @author Mark Hayes
 */
public class PersistComparator implements
    ...
    public PersistComparator(PersistKeyBinding binding) {
        ...
        comositeFieldOrder = CompositeKeyFormat.getFieldNameArray(format.getClassMetadata().getCompositeKeyFields());
