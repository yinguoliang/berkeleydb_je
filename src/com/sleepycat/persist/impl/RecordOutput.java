...
class RecordOutput extends TupleOutput implements EntityOutput {
    ...
    public void writeObject(Object o, Format fieldFormat) throws RefreshException {
        ...
        if (rawAccess) {
             ...
             * embedded entity. We will detect that error below, but we must not
             * fail first when attempting to open the secondaries.
             */
         ...
         * (ProxiedFormat for example) prohibit nested fields that reference the
         * parent object. [#15815]
         */
    ...
    public void writeKeyObject(Object o, Format fieldFormat) throws RefreshException {
        ...
        if (fieldFormat != format) {
            throw new IllegalArgumentException("The key field object class (" + o.getClass().getName()
                    + ") must be the field's declared class: " + fieldFormat.getClassName());
        }
