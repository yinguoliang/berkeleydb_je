...
/**
 * A static catalog containing simple types only. Once created, this catalog is
 * immutable. For bindings accessed by a PersistComparator during recovery, the
 ...
 * regular PersistCatalog. This class also contains utility methods for dealing
 * with primitives.
 *
 * @author Mark Hayes
 */
public class SimpleCatalog implements Catalog {
    ...
    /**
     * Tells a primitive format about the format for its corresponding primitive
     * wrapper class.
     */
