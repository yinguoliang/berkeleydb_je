...
public interface EntityInput {
     ...
     * the primary key field and composite key fields (see readKeyObject below).
     */
     ...
     * type.
     * <p>
     * For such key fields, no formatId is present nor can the object already be
     * present in the visited object set.
     * </p>
     */
    Object readKeyObject(Format format) throws RefreshException;

    /**
     * Called for a String field, that is not a primary key field or a composite
     * key field with a reference type.
     * <p>
     * For the new String format, no formatId is present nor can the object
     * already be present in the visited object set. For the old String format,
     * this method simply calls readObject for compatibility.
     * </p>
     */
    ...
    /**
     * Called via Accessor.readSecKeyFields for a primary String key field. This
     * method must be called before reading any other fields.
     */
