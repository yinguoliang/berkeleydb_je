 ...
 * begin JE only -->
 * <p>
 * In a replicated environment, this exception is also thrown when upgrading an
 * application (persistent classes have been changed) and an upgraded node is
 * elected Master before all of the Replica nodes have been upgraded. See
