...
/**
 * A mutation for converting an old version of an object value to conform to the
 * current class or field definition. For example:
 *
 * <pre class="code">
 *  package my.package;
 *
...
public class Converter extends Mutation {
    ...
    public Converter(String declaringClassName, int declaringClassVersion, String fieldName, Conversion conversion) {
        ...
        try {
            ...
            if (m.getDeclaringClass() == Object.class) {
                throw new IllegalArgumentException("Conversion class does not implement the equals method "
                        + "explicitly (Object.equals is not sufficient): " + cls.getName());
            }
    ...
    /**
     * Returns true if the conversion objects are equal in this object and given
     * object, and if the {@link Mutation#equals} superclass method returns
     * true.
     */
    @Override
