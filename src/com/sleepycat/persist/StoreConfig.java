 ...
 * .
 * <p>
 * {@code StoreConfig} objects are thread-safe. Multiple threads may safely call
 * the methods of a shared {@code StoreConfig} object.
 * </p>
 * <p>
 * See the <a href="package-summary.html#example">package summary example</a>
 * for an example of using a {@code StoreConfig}.
 * </p>
 *
 * @author Mark Hayes
 */
public class StoreConfig implements Cloneable {
     ...
     * property is false.
     * <p>
     * If this property is false and the internal store metadata database does
     * not exist, {@link DatabaseException} will be thrown when the store is
     * opened.
     * </p>
     *
     ...
     * <p>
     * If this property is true and the internal store metadata database already
     * exists, {@link DatabaseException} will be thrown when the store is
     * opened.
     * </p>
     *
     ...
     * is false.
     * <p>
     * This property is true to open all store indices for transactional access.
     * True may not be specified if the environment is not also transactional.
     * </p>
     *
     ...
     * false.
     * <p>
     * This property is true to open all store indices for read-only access, or
     * false to open them for read-write access. False may not be specified if
     ...
     * store is replicated in a replicated Environment.
     * <p>
     * In a non-replicated Environment, this property is ignored. All stores are
     * non-replicated in a non-replicated Environment.
     *
     * @param replicated whether the store is replicated.
     * @return 'this'.
     * @see <a href="../je/rep/ReplicatedEnvironment.html#nonRepDbs">Non-
     *      replicated Databases in a Replicated Environment</a>
     */
     ...
     * Environment, this property is ignored. All stores are non-replicated in a
    ...
    /**
     * Sets the deferred-write configuration property. By default this property
     * is false.
     * <p>
     ...
     * false.
     * <p>
     * This property is true to open all store databases as temporary databases.
     * True may not be specified if the store is transactional.
     * </p>
     * <p>
     ...
     * property is false.
     * <p>
     * This property is true to cause the initial creation of secondary indices
     * to be performed as a bulk load. If this property is true and
     * {@link EntityStore#getSecondaryIndex EntityStore.getSecondaryIndex} has
     * never been called for a secondary index, that secondary index will not be
     * created or written as records are written to the primary index. In
     ...
     * getSecondaryIndex} method is called for the first time for that index, or
     * when the store is closed and re-opened with this property set to false
     * and the primary index is obtained. In either case, the secondary index is
     * populated by reading through the entire primary index and adding records
     * to the secondary index as needed. While populating the secondary, foreign
     * key constraints will be enforced and an exception is thrown if a
     * constraint is violated.
     * </p>
     * <p>
     * When loading a primary index along with secondary indexes from a large
     * input data set, configuring a bulk load of the secondary indexes is
     * sometimes more performant than updating the secondary indexes each time
     * the primary index is updated. The absence of foreign key constraints
     * during the load also provides more flexibility.
     * </p>
     *
     ...
     * <p>
     * If null is specified or this method is not called, an
     * {@link AnnotationModel} instance is used by default.
     * </p>
     *
     ...
     * last opened. Some new mutations may override existing specifications, and
     * some may be supplemental.
     * <p>
     ...
     * incompatible with the class definitions known to this store. See
     * {@link Mutations} and {@link com.sleepycat.persist.evolve Class
     ...
     * <!-- begin JE only -->
     * 
     * @hidden <!-- end JE only --> Specifies the object reponsible for naming
     *         of files and databases. By default this property is
     *         {@link DatabaseNamer#DEFAULT}.
     ...
     * <!-- begin JE only -->
     * 
     * @hidden <!-- end JE only --> Returns the object reponsible for naming of
     *         files and databases.
