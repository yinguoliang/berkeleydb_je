 ...
 * integer value specifies the sort order of this field within the set of fields
 * in the composite key.
 * <p>
 * If the field type of a {@link PrimaryKey} or {@link SecondaryKey} is a
 ...
 * the composite key class. The {@code KeyField} value must be a number between
 * one and the number of non-transient instance fields declared in the composite
 * key class.
 * </p>
 * <p>
 * Note that a composite key class is a flat container for one or more simple
 * type fields. All non-transient instance fields in the composite key class are
 * key fields, and its superclass must be {@code Object}.
 * </p>
 * <p>
 * For example:
 * </p>
 ...
 * </pre>
 * <p>
 * This causes entities to be sorted first by {@code kingdom}, then by
 * {@code phylum} within {@code kingdom}, and so on.
 * </p>
 * <p>
 * The fields in a composite key class may not be null.
 * </p>
 * <p>
 * <a name="comparable"><strong>Custom Sort Order</strong></a>
 * </p>
 * <p>
 * To override the default sort order, a composite key class may implement the
 * {@link Comparable} interface. This allows overriding the sort order and is
 * therefore useful even when there is only one key field in the composite key
 * class. For example, the following class sorts Strings using a Canadian
 * collator:
 * </p>
 *
 * <pre class="code">
 ...
 * comparison method. Failure to follow these rules may result in the primary or
 * secondary index becoming unusable; in other words, the store will not be able
 * to function.
 * </p>
 * <ol>
 * <li>The comparison method must always return the same result, given the same
 * inputs. The behavior of the comparison method must not change over time.</li>
