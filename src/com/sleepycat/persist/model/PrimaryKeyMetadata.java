...
/**
 * The metadata for a primary key field. A primary key may be specified with the
 * {@link PrimaryKey} annotation.
 * <p>
 * {@code PrimaryKeyMetadata} objects are thread-safe. Multiple threads may
 * safely call the methods of a shared {@code PrimaryKeyMetadata} object.
 * </p>
 *
 * @author Mark Hayes
 */
public class PrimaryKeyMetadata extends FieldMetadata {
     ...
     */
    public PrimaryKeyMetadata(String name, String className, String declaringClassName, String sequenceName) {
