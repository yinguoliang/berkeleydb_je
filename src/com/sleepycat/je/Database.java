...
public class Database implements Closeable {
	 ...
	 *
	 * The handleLocker field is set to null during close to avoid OOME. It is
	 * only accessed during close, while synchronized, so checking for null is
	 * unnecessary.
	 */
	 ...
	 *             via Environment.openDatabase and openSecondaryDatabase.
	 */
	 ...
	 *             if cursors associated with this database are still open.
	 */
	public void close() {
		try {
	 ...
	 * aborted.
	 *
	 * Note that this method (unlike close) does not perform sync and removal of
	 * DW DBs. A DW DB cannot be transactional.
	 */
	...
	private void closeInternalWork(final boolean doSyncDw, final boolean deleteTempDb, final DbState newState,
		 ...
		 * Statements above are synchronized but this section must not be.
		 *
	 ...
	 *             if this is not a deferred-write database, or this database is
	 *             read-only.
	 *
	 * @throws IllegalStateException
	 ...
	 *
	 * @param key
	 *            The key {@link DatabaseEntry} of the sequence.
	 *
	 * @param config
	 ...
	 *             if the sequence record already exists and the
	 *             {@code SequenceConfig ExclusiveCreate} parameter is true.
	 *
	 * @throws SequenceNotFoundException
	 *             if the sequence record does not exist and the
	 *             {@code SequenceConfig AllowCreate} parameter is false.
	 *
	 * @throws OperationFailureException
	 *             if one of the
	 ...
	 *
	 * @throws UnsupportedOperationException
	 *             if this database is read-only, or this database is configured
	 *             for duplicates.
	 *
	 * @throws IllegalStateException
	 *             if the Sequence record is deleted by another thread during
	 *             this method invocation, or the database has been closed.
	 *
	 * @throws IllegalArgumentException
	 ...
	 *
	 * @param key
	 *            The key {@link com.sleepycat.je.DatabaseEntry DatabaseEntry}
	 *            of the sequence.
	 *
	 * @throws OperationFailureException
	 *             if one of the
	 ...
	 * @hidden For internal use only.
	 *
	 *         Given the {@code key}, {@code data} and {@code expirationTime}
	 *         for a locked primary DB record, update the corresponding
	 *         secondary database (index) records, for secondaries enabled for
	 ...
	 * 
	 * @param key
	 *            is the key of the locked primary record.
	 *
	 * @param data
	 *            is the data of the locked primary record.
	 *
	 * @param expirationTime
	 *            the expiration time of the locked primary record. This can be
	 *            obtained from {@link OperationResult#getExpirationTime()} when
	 *            reading the primary record.
	 *
	 * @param cacheMode
	 *            the CacheMode to use, or null for the Database default.
	 */
	public void populateSecondaries(final Transaction txn, final DatabaseEntry key, final DatabaseEntry data,
	 ...
	 *             null input key parameter, an input key parameter with a null
	 *             data array, or a partial key input parameter.
	 *
	 * @since 7.0
	 */
	 ...
	 *             key/data parameter with a null data array, and a partial
	 ...
	 *
	 * @throws UnsupportedOperationException
	 *             if the database is read-only, or putType is Put.NO_DUP_DATA
	 *             and the database is not configured for duplicates.
	 *
	 * @throws IllegalStateException
	 *             if the database has been closed.
	 *
	 ...
	 *
	 * @throws UnsupportedOperationException
	 *             if this database is not configured for duplicates, or this
	 ...
	 *
	 * @param cursors
	 *            an array of cursors associated with this primary database. In
	 *            a replicated environment, an explicit transaction must be
	 ...
	 *
	 * @param maxMillisecs
	 *            The maximum time in milliseconds to use when preloading.
	 *            Preloading stops once this limit has been reached. If
	 *            maxMillisecs is 0, preloading can go on indefinitely or until
	 *            maxBytes (if non-0) is reached.
	 *
	 * @throws OperationFailureException
	 *             if one of the
	 *             <a href="OperationFailureException.html#readFailures">Read
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if {@code PreloadConfig.getMaxBytes} is greater than size of
	 *             the JE cache.
	 */
	 ...
	 * considered a fairly expensive operation.
	 *
	 ...
	 * one used by this method, use the {@link Database#count(long memoryLimit)}
	 * method.
	 *
	 ...
	 *
	 * @param memoryLimit
	 *            The maximum memory (in bytes) that may be consumed by this
	 *            method.
	 *
	 * @return The count of key/data pairs in the database.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if either entry is a partial DatabaseEntry, or is null.
	 */
	 ...
	 *
	 * @throws IllegalStateException
	 *             if the database has been closed since checkOpen was last
	 *             called.
	 */
	...
	SecondaryIntegrityException secondaryRefersToMissingPrimaryKey(final Locker locker, final DatabaseEntry secKey,
			final DatabaseEntry priKey, final long expirationTime) {
