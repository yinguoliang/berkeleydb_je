...
public class CursorConfig implements Cloneable {
	 ...
	 *            If true, configure read operations performed by the cursor to
	 ...
	 *
	 * @param nonSticky
	 *            if false (the default), the prior position is maintained by
	 *            cursor movement operations, and the cursor stays at the prior
	 *            position when {@code NOTFOUND} is returned. If true, the prior
	 *            position is not maintained, and the cursor is reinitialized
	 *            when {@code NOTFOUND} is returned.
	 *
	 * @return this
	 */
