...
public class Sequence implements Closeable {
     ...
     * cover the <code>delta</code> and the next batch of cached values. This
     * method is synchronized to protect updating of the cached value, since
     * multiple threads may share a single handle. Multiple handles for the same
     * database/key may be used to increase concurrency.
     * </p>
     * <p>
