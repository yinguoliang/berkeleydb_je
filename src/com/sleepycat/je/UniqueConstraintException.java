 ...
 * {@link SecondaryDatabase} is not configured to allow duplicate keys (which is
 * the default, see {@link DatabaseConfig#setSortedDuplicates}). This implies
 * the use of a one-to-one or one-to-many relationship.
 * </p>
 * <p>
 ...
 * {@link com.sleepycat.persist.model.Relationship#ONE_TO_ONE} or
 * {@link com.sleepycat.persist.model.Relationship#ONE_TO_MANY} relationship.
 * </p>
 * <p>
...
public class UniqueConstraintException extends SecondaryConstraintException {
     ...
     * @hidden
     */
    public UniqueConstraintException(Locker locker, String message, String secDbName, DatabaseEntry secKey,
