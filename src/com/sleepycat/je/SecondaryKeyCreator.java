 ...
 * When more than one secondary key may be present (for many-to-many and
 * one-to-many relationships), use the {@link SecondaryMultiKeyCreator}
 * interface instead. The table below summarizes how to create all four
