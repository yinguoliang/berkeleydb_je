 ...
 * applicable when using the {@link com.sleepycat.persist DPL}. All other items
 * below do not apply to the use of the DPL, because the DPL ensures that
 * secondary databases are configured and managed correctly.
 * </p>
 * <ol>
 * <li>The use of non-transactional databases or stores can cause secondary
 * corruption as described in
