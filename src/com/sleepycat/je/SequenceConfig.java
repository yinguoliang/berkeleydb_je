...
public class SequenceConfig implements Cloneable {
	 ...
	 *            {@link com.sleepycat.je.Database#openSequence
	 *            Database.openSequence} method to create the sequence if it
	 ...
	 *         Database.openSequence} method is configured to create the
	 ...
	 *
	 * @param cacheSize
	 *            The number of elements cached by a sequence handle. May not be
	 *            larger than the size of the range defined by {@link #setRange}
	 *            .
	 *
	 * @return this
	 */
	 ...
	 *
	 * @param decrement
	 *            If true, specify that the sequence should be decremented.
	 *
	 * @return this
	 */
	 ...
	 *            If true, configure the
	 *            {@link com.sleepycat.je.Database#openSequence
	 *            Database.openSequence} method to fail if the database already
	 *            exists.
	 *
	 * @return this
	 */
	 ...
	 *
	 * @return true if the {@link com.sleepycat.je.Database#openSequence
	 *         Database.openSequence} method is configured to fail if the
	 ...
	 *
	 * @param initialValue
	 *            The initial value for a sequence. Must be within the range
	 ...
	 *            If true, configure auto-commit operations on the sequence to
	 *            not flush the transaction log.
	 *
	 * @return this
	 */
	 ...
	 *
	 * <p>
	 * The default minimum is {@code Long.MIN_VALUE} and the default maximum is
	 * {@code Long.MAX_VALUE}.
	 * </p>
	 *
	 * @param min
	 *            The minimum value for the sequence. Must be less than max.
	 *
	 * @param max
	 *            The maximum value for the sequence. Must be greater than min.
	 *
	 * @return this
	 */
	...
	/**
	 * @hidden Configures a sequence range minimum value. This call is only
	...
	/**
	 * @hidden Configures a sequence range maximum value. This call is only
	 *         effective when the sequence is being created.
	 *
	 *         <p>
	 ...
	 *            is incremented (decremented) past the specified maximum
	 *            (minimum) value.
	 *
	 * @return this
	 */
