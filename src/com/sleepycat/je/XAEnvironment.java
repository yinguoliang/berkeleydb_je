...
public class XAEnvironment extends Environment implements XAResource {
	...
	public void end(Xid xid, int flags) throws XAException {
		...
		if ((!tmFail && !tmSuccess && !tmSuspend) || (tmFail && tmSuccess) || ((tmFail || tmSuccess) && tmSuspend)) {
		...
		if (DEBUG) {
			System.out.println(
					"Transaction for " + Thread.currentThread() + " is " + envImpl.getTxnManager().getTxnForThread());
		}
