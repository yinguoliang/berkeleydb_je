...
public interface ProgressListener<T extends Enum<T>> {
     ...
     *
     * @param phase an enum indicating the phase of the operation for which
     ...
     *            if it is known by JE. If total is < 0, then the total number
     *            is unknown. When total == n, this indicates that processing of
