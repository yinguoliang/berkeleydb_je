 ...
 * a foreign key integrity constraint. The delete action is specified by calling
 * {@link SecondaryConfig#setForeignKeyDeleteAction}.
 * </p>
 * <p>
 * When a record in the foreign key database is deleted, it is checked to see if
 * it is referenced by any record in the associated secondary database. If the
 * key is referenced, the delete action is applied. By default, the delete
 * action is {@link #ABORT}.
 * </p>
 *
 * @see SecondaryConfig
 */
