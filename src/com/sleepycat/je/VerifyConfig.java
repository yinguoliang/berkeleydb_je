...
public class VerifyConfig implements Cloneable {
    ...
    /**
     * Configures {@link com.sleepycat.je.Environment#verify Environment.verify}
     * and {@link com.sleepycat.je.Database#verify Database.verify} to propagate
     ...
     *            {@link com.sleepycat.je.Environment#verify Environment.verify}
     *            and {@link com.sleepycat.je.Database#verify Database.verify}
     ...
     *         Environment.verify} and {@link com.sleepycat.je.Database#verify
     *         Database.verify} are configured to propagate exceptions found
     *         during verification.
     */
    ...
    /**
     * Configures {@link com.sleepycat.je.Environment#verify Environment.verify}
     * and {@link com.sleepycat.je.Database#verify Database.verify} to perform
     * fine granularity consistency checking that includes verifying in memory
     * constructs.
     * <p>
     ...
     * @return true if the {@link com.sleepycat.je.Environment#verify
     *         Environment.verify} and {@link com.sleepycat.je.Database#verify
     *         Database.verify} are configured to perform fine granularity
     *         consistency checking that includes verifying in memory
     *         constructs.
     */
    ...
    /**
     * Configures {@link com.sleepycat.je.Environment#verify Environment.verify}
     * and {@link com.sleepycat.je.Database#verify Database.verify} to print
     * basic verification information to System.out.
     * <p>
     * By default this is false.
     * </p>
     *
     ...
     * @return true if the {@link com.sleepycat.je.Environment#verify
     *         Environment.verify} and {@link com.sleepycat.je.Database#verify
     *         Database.verify} are configured to print basic verification
