...
public class DatabaseConfig implements Cloneable {
     ...
     * already exist.
     *
     * @param allowCreate If true, configure the
     ...
     * </p>
     *
     * @param exclusiveCreate If true, configure the
     *            {@link com.sleepycat.je.Environment#openDatabase
     ...
     *            duplicate data items. A value of false is illegal to this
     *            method, that is, once set, the configuration cannot be
     *            cleared.
     * @return this
     */
    ...
    /**
     * @hidden For internal use only. Specifies the list of triggers associated
     *         with the database; triggers are executed in the order specified
     *         by this list.
     *         <p>
     ...
     *             unique names, have conflicting types (e.g. only a subset
     *             implement {@link ReplicatedDatabaseTrigger
     *             ReplicatedDatabaseTrigger}), or do not implement
    ...
    /**
     * @hidden For internal use only. Returns the list of configured database
     *         triggers.
     */
    ...
    /**
     * @hidden For internal use only. Set to true if the database exists and the
    ...
    /**
     * @hidden For internal use only. Returns the override setting for triggers.
     */
     ...
     * set to true.
     *
     * @param useExistingConfig true if this Database should be opened using the
    ...
    /**
     * @hidden For internal use only. Configures a SecondaryAssociation that is
     *         used to define primary-secondary associations for a group of
     *         primary and secondary databases. The same SecondaryAssociation
     *         instance must be configured on the primary and secondary
     *         databases.
    ...
    /**
     * @hidden For internal use only. Returns the configured
    ...
    boolean checkTriggers(List<Trigger> triggerList) {
        ...
        for (Trigger trigger : triggerList) {
             ...
             * testing of these partially implemented features. if (trigger
             * instanceof PersistentTrigger) { throw new
    ...
    static DatabaseConfig combineConfig(DatabaseImpl dbImpl, DatabaseConfig dbHandleConfig) {
         ...
         * might have changed from other database handles. Note: sorted
         * duplicates, temporary and replicated attributes are not mutable and
         * were checked at handle creation to make sure these properties in
         * dbHandleConfig are consistent with DatabaseImpl. They're still set
         * here in case the useExistingConfig property is set, and those field
