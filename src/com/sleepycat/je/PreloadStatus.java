...
public class PreloadStatus implements Serializable {
	...
	/**
	 * {@link com.sleepycat.je.Database#preload Database.preload} was
	 * successful.
	 */
	public static final PreloadStatus SUCCESS = new PreloadStatus("SUCCESS");

	/**
	 * {@link com.sleepycat.je.Database#preload Database.preload} filled
	 * maxBytes of the cache.
	 */
	public static final PreloadStatus FILLED_CACHE = new PreloadStatus("FILLED_CACHE");

	/**
	 * {@link com.sleepycat.je.Database#preload Database.preload} took more than
	 * maxMillisecs.
	 */
