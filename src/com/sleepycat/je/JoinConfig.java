...
public class JoinConfig implements Cloneable {
     ...
     * {@link com.sleepycat.je.Database#join Database.join}.
     */
     ...
     * normally results from sorting the cursors from the one that refers to the
     * least number of data items to the one that refers to the most. Unless
     * this method is called with true, <code>Database.join</code> does this
     * sort on behalf of its caller using the {@link Cursor#countEstimate}
     * method.
     * </p>
     * <p>
     ...
     * other than the default. Calling this method permits applications to
     * perform join optimization prior to calling <code>Database.join</code>.
     * </p>
     *
