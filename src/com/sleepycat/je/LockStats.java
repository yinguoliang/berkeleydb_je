 ...
 *
 * <p>
 * Note that some of the lock statistics may be expensive to obtain because the
 * lock table is unavailable to other operations while the statistics are
 * gathered. These expensive statistics are only provided if
 * {@link com.sleepycat.je.Environment#getLockStats Environment.getLockStats} is
...
public class LockStats implements Serializable {
	...
	/**
	 * @hidden For internal use only. Create a stat api instance to house lock
	 *         related information.
	 */
	 ...
	 * {@link com.sleepycat.je.Environment#getLockStats
	 * Environment.getLockStats} is called in "slow" mode.
	 */
	...
	/**
	 * For convenience, LockTable.toString will display all stats in an easily
	 * readable format.
	 */
	@Override
