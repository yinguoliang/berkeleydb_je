 ...
 * programming error, a standard Java runtime exception is thrown:
 * {@link IllegalArgumentException}, {@link IllegalStateException} or
 * {@link UnsupportedOperationException}. These exceptions have the standard
 * meaning defined by their javadoc. Note that JE throws
 * {@link IllegalArgumentException} rather than {@link NullPointerException}
 * when a required parameter is null.</li>
 ...
 * details.</li>
 * <li>When an {@code Environment} failure occurs,
 ...
 * which extends {@code DatabaseException}. {@link RunRecoveryException} exists
 ...
 * {@link com.sleepycat.je.Database#get Database.get} returns
