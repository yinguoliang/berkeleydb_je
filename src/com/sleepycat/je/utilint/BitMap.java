 ...
 * that each segment is only instantiated when needed. Note that this class is
 * currently not thread safe; adding a new bitset segment is not protected.
 */
public class BitMap {
     ...
     * @param allowCreate if true, return the BitSet that would hold this index
     * even if it wasn't previously set. If false, return null if the bit has
     * not been set.
     */
