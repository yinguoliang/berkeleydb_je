 ...
 * per-class-instance. In rare cases, this ConsoleHandler may be used to
 * actually publish on its own.
 */
public class ConsoleRedirectHandler extends java.util.logging.ConsoleHandler {
    ...
    public void publish(LogRecord record) {
         ...
         * log to the generic ConsoleHandler without an identifying prefix. That
         * way, we get a message, but don't risk a NullPointerException.
         */
        if (envImpl == null) {
