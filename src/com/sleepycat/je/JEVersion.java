...
public class JEVersion implements Comparable<JEVersion>, Serializable {
	 ...
	 * Release version.
	 */
	public static final JEVersion CURRENT_VERSION = new JEVersion(7, 4, 5, null);
	...
	/*
	 * If its type is JEVersion, and the version numbers are the same, then we
	 * consider these two versions equal.
	 */
	@Override
