...
public class StatsConfig implements Cloneable {
    ...
    /**
     * A convenience instance for which setClear(true) has been called, and all
    ...
    /**
     * Returns true if the statistics operation is configured to return only the
     * values which do not require expensive actions.
     *
     * @return true if the statistics operation is configured to return only the
     *         values which do not require expensive actions.
     */
     ...
     * PrintStream argument. The accumulated statistics will be displayed every
     * N records, where N is the value of showProgressInterval.
     *
     * @return this
     */
