 ...
 * {@code Environment}.
 * <p>
 * This {@code InputStream} reads input from some other given {@code
 * InputStream}, and verifies checksums while reading. Its primary intended use
 * is to verify log files that are being copied as part of a programmatic
 ...
 * </p>
 * <p>
 * Note that {@code mark} and {@code reset} are not supported and {@code
 * markSupported} returns false. The default {@link InputStream} implementation
...
public class LogVerificationInputStream extends InputStream {
     ...
     */
    public LogVerificationInputStream(final Environment env, final InputStream in, final String fileName) {
     ...
     * fileName.
     */
    LogVerificationInputStream(final EnvironmentImpl envImpl, final InputStream in, final String fileName,
                               final long fileNum) {
     ...
     * {@inheritDoc}
     * <p>
     * This method reads the underlying {@code InputStream} and verifies the
     ...
     * {@inheritDoc}
     * <p>
     * This method reads the underlying {@code InputStream} in order to skip the
     * required number of bytes and verifies the contents of the stream. A
     * temporary buffer is allocated lazily for reading.
     * </p>
     *
     * @throws LogVerificationException if a checksum cannot be verified or a
     *             log entry is determined to be invalid by examining its
    ...
    public long skip(final long bytesToSkip) throws IOException {
        ...
        /*
         * Like InputStream.skip, we lazily allocate a skip buffer. We must read
         * the data in order to validate the checksum. Unlike the
     ...
     * {@inheritDoc}
     * <p>
     * This method simply performs <code>in.available()</code>.
     */
    @Override
