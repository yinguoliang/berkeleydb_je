 ...
 *
 * @see <a href="{@docRoot}/../GettingStartedGuide/managelogging.html"> Chapter
 *      12. Logging</a>
...
public class FileHandler extends java.util.logging.FileHandler {
     ...
     * exception. For instance, when we send an interrupt() to the Rep Node we
     * can see an InterruptedIOException written to stderr, but it never gets
     * passed to the caller. For several tests, this causes irrelevant stack
     * traces to spew out even though no execption is ever thrown at us. e.g.
     * ------------- Standard Error -----------------
     * java.util.logging.ErrorManager: 2 java.io.InterruptedIOException at
     ...
     * java.util.logging.FileHandler$MeteredStream.flush(FileHandler.java:143)
     * at sun.nio.cs.StreamEncoder.implFlush(StreamEncoder.java:278) at
     * sun.nio.cs.StreamEncoder.flush(StreamEncoder.java:122) at
     * java.io.OutputStreamWriter.flush(OutputStreamWriter.java:212) at
     * java.util.logging.StreamHandler.flush(StreamHandler.java:225) at
     * java.util.logging.FileHandler.publish(FileHandler.java:556) at
     * com.sleepycat.je.utilint.FileRedirectHandler.publish(FileRedirectHandler.
     * java:54) at java.util.logging.Logger.log(Logger.java:458) at
     * java.util.logging.Logger.doLog(Logger.java:480) at
     * java.util.logging.Logger.log(Logger.java:503) at
     * com.sleepycat.je.utilint.LoggerUtils.logMsg(LoggerUtils.java:343) at
     * com.sleepycat.je.utilint.LoggerUtils.info(LoggerUtils.java:395) at
     * com.sleepycat.je.rep.impl.node.FeederManager.runFeeders(FeederManager.
     * java:449) at
     * com.sleepycat.je.rep.impl.node.RepNode.run(RepNode.java:1198)
     */
     ...
     * default.
     */
    public FileHandler(String pattern, int limit, int count, Formatter formatter, EnvironmentImpl envImpl)
        ...
        Level level = LoggerUtils.getHandlerLevel(envImpl.getConfigManager(), EnvironmentParams.JE_FILE_LEVEL,
