...
/**
 * Loads a database from a dump file generated by {@link DbDump}. This utility
 * may be used programmatically or from the command line.
 * <p>
...
public class DbLoad {
     ...
     *            </pre>
     *            <p>
     *            -f - the file to load from (in DbDump format)<br>
     ...
     *            </p>
     *            <p>
     *            The -T option allows JE applications to easily load text files
     *            into databases.
     *            </p>
     *            <p>
     *            The -I option allows loading databases that were dumped with
     *            the Berkeley DB C product, when the dump file contains
     *            parameters not known to JE.
     *            </p>
     *            <p>
     *            The input must be paired lines of text, where the first line
     *            of the pair is the key item, and the second line of the pair
     *            is its corresponding data item.
     *            </p>
     *            <p>
     ...
     *            If the backslash character precedes another backslash
     *            character, the pair will be interpreted as a literal
     *            backslash. If the backslash character precedes any other
     *            character, the two characters following the backslash will be
     *            interpreted as a hexadecimal specification of a single
     *            character; for example, \0a is a newline character in the
     *            ASCII character set.
     *            </p>
     *            <p>
     *            For this reason, any backslash or newline characters that
     *            naturally occur in the text input must be escaped to avoid
     *            misinterpretation by db_load.
     *            </p>
     *            <p>
     *            -c name=value - Specify configuration options ignoring any
     *            value they may have based on the input. The command-line
     *            format is name=value. See the Supported Keywords section below
     *            for a list of keywords supported by the -c option.
     *            </p>
     *            <p>
     *            -s database - the database to load.<br>
     *            -h dbEnvHome - the directory containing the database
     *            environment.<br>
     *            -v - report progress <br>
     *            </p>
     *            <p>
     *            Supported Keywords<br>
     *            version=N - specify the version of the input file. Currently
     *            only version 3 is supported.<br>
     *            format - specify the format of the file. Allowable values are
     *            "print" and "bytevalue".<br>
     *            dupsort - specify whether the database allows duplicates or
     *            not. Allowable values are "true" and "false".<br>
     *            type - specifies the type of database. Only "btree" is
     *            allowed.<br>
    ...
    private static DbLoad parseArgs(String argv[]) throws Exception {
        ...
        if (inputFileName == null) {
            ...
            if (showProgressInterval) {
                ...
                /*
                 * Can't show progress if we don't know how big the stream is.
                 */
    ...
    /**
     * If true, enables output of warning messages. Command line behavior is not
    ...
    /**
     * Sets whether to ignore unknown parameters in the config file. This allows
     * loading databases that were dumped with the Berkeley DB C product, when
     * the dump file contains parameters not known to JE.
     *
     * @param ignoreUnknownConfigMode True to ignore unknown parameters in the
     *            config file.
     */
    ...
    /**
     * Used for progress status messages. Must be set to greater than 0 if the
     * progressInterval is greater than 0.
     *
    ...
    public boolean load() throws IOException, DatabaseException {
        ...
        LoggerUtils.envLogMsg(Level.INFO, DbInternal.getNonNullEnvImpl(env), "DbLoad.load of " + dbName + " starting");
        ...
        LoggerUtils.envLogMsg(Level.INFO, DbInternal.getNonNullEnvImpl(env), "DbLoad.load of " + dbName + " ending.");
    ...
    private static byte backSlashValue = ((byte) ('\\')) & 0xff;
