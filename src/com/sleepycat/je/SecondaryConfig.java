...
public class SecondaryConfig extends DatabaseConfig {
     ...
     *            integrity constraint, or null if no foreign key constraint
     *            should be checked.
     * @return this
     */
     ...
     * </p>
     *
     * @param foreignMultiKeyNullifier the user-supplied object used for setting
     *            multi-valued foreign keys to null.
    ...
    /**
     * @hidden For internal use only. Specifies whether the key
     *         extractor/creator will only use the primary key.
     *         <p>
    ...
    /**
     * @hidden For internal use only. Returns whether the key extractor/creator
     *         will only use the primary key. If
     *         {@link #setExtractFromPrimaryKeyOnly} has not been called, this
