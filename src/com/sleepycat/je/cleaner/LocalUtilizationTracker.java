 ...
 * <p>
 * Per-database information is keyed by DatabaseImpl so that no tree lookup of a
 * database is required (as when a DatabaseId is used).
 * </p>
 * <p>
 * The countNewLogEntry, countObsoleteNode and countObsoleteNodeInexact methods
 * may be called without taking the log write latch. Totals and offset are
 * accumulated locally in this object only, not in DatabaseImpl objects.
 * </p>
 * <p>
