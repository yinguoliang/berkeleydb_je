...
public class EnvironmentMutableConfig implements Cloneable, Serializable {
     ...
     *            on transaction commit. This means that transactions exhibit
     *            the ACI (Atomicity, Consistency, and Isolation) properties,
     *            but not D (Durability); that is, database integrity is
     *            maintained, but if the operating system fails, it is possible
     ...
     *            performed in this environment. If {@code null} is specified,
