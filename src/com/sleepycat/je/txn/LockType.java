...
public class LockType {
     ...
     * @see #getConflict
     */
    private static LockConflict[][] conflictMatrix = { {                                            // READ is held and there is a request for:
     ...
     * @see #getUpgrade
     */
    private static LockUpgrade[][]  upgradeMatrix  = { {                                            // READ is held and there is a request for:
