...
public class BtreeStats extends DatabaseStats {
	 ...
	 *
	 * <p>
	 * The information is included only if the
	 * {@link com.sleepycat.je.Database#getStats Database.getStats} call was not
	...
	/**
	 * Returns the number of deleted data records in the database tree that are
	 ...
	 *         number of records. This is calculated without locks or
	 *         transactions, and therefore is only an accurate count of the
	 ...
	 * Internal Nodes with various percentages of non-deleted entry counts. The
	 * array is 10 elements and each element represents a range of 10%.
	 *
	 * <pre>
	 ...
	 * on this database's BTree. Latch upgrades are required when an operation
