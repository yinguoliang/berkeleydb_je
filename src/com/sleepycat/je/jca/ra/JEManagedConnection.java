...
public class JEManagedConnection implements ManagedConnection {
    ...
    public LocalTransaction getLocalTransaction() {
         ...
         * off the JELocalTransaction to the JEConnection and forget about it in
    ...
    SecondaryDatabase openSecondaryDatabase(String dbName, Database primaryDatabase, SecondaryConfig config)
            throws DatabaseException {

        if (config.getReadOnly()) {
            synchronized (roSecondaryDatabaseHandleCache) {
                return openSecondaryDatabaseInternal(roSecondaryDatabaseHandleCache, dbName, primaryDatabase, config);
            }
        } else {
            synchronized (rwSecondaryDatabaseHandleCache) {
                return openSecondaryDatabaseInternal(rwSecondaryDatabaseHandleCache, dbName, primaryDatabase, config);
            }
        }
    }

    private Database openDatabaseInternal(Map<String, Database> databaseHandleCache, String dbName,
    ...
    private SecondaryDatabase openSecondaryDatabaseInternal(Map<String, Database> databaseHandleCache, String dbName,
                                                            Database primaryDatabase, SecondaryConfig config)
            throws DatabaseException {
