...
/**
 * The interface for Consistency policies used to provide consistency guarantees
 * at a Replica. ReplicaConsistencyPolicies are only used by Berkeley DB JE High
 * Availability.
 * <p>
 * A transaction initiated at a Replica will wait in the
 * {@link com.sleepycat.je.Environment#beginTransaction} method until the
 * consistency policy is satisfied. Consistency policies are specified at either
 * a per-transaction level through
 * {@link TransactionConfig#setConsistencyPolicy} or as an replication node wide
 * default through
