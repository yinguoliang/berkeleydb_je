...
public class DbInternal {
	...
	public static OperationResult search(final Cursor cursor, final DatabaseEntry key, final DatabaseEntry data,
			final LockMode lockMode, final SearchMode searchMode, final boolean countOpStat) {
	...
	public static OperationResult searchForReplay(final Cursor cursor, final DatabaseEntry key,
			final DatabaseEntry data, final LockMode lockMode, final SearchMode searchMode) {
	...
	public static OperationResult retrieveNext(final Cursor cursor, final DatabaseEntry key, final DatabaseEntry data,
			final LockMode lockMode, final GetMode getMode) throws DatabaseException {
	...
	public static OperationResult putForReplay(final Cursor cursor, final DatabaseEntry key, final DatabaseEntry data,
			final LN ln, final int expiration, final boolean expirationInHours, final PutMode putMode,
	 ...
	 * will land on the last dup for the matching key.
	 *
	 ...
	 * code. For example, an LTE search would actually more efficient than the
	 * existing GTE search (getSearchKeyRange and getSearchBothRange).
	 *
	...
	public static void checkImmutablePropsForEquality(final EnvironmentMutableConfig config,
			final Properties handleConfigProps) throws IllegalArgumentException {
