...
public class TransactionConfig implements Cloneable {
     ...
     *         equivalent durability settings. Figure out what we should do on
     *         commit. TransactionConfig could be set with conflicting values;
     *         take the most stringent ones first. All environment level
     *         defaults were applied by the caller. ConfigSync ConfigWriteNoSync
     *         ConfigNoSync default 0 0 0 sync 0 0 1 nosync 0 1 0 write nosync 0
     *         1 1 write nosync 1 0 0 sync 1 0 1 sync 1 1 0 sync 1 1 1 sync
     ...
     *            but if the application or system fails, it is possible some
     *            number of the most recently committed transactions may be
     *            undone during recovery. The number of transactions at risk is
     *            governed by how many log updates can fit into the log buffer,
     *            how often the operating system flushes dirty buffers to disk,
    ...
    /**
     * Returns the durability associated with the configuration. If
     * {@link #setDurability} has not been called, this method returns null.
