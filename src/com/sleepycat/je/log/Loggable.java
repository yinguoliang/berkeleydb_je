...
/**
 * A class that implements Loggable knows how to read and write itself into a
 * ByteBuffer in a format suitable for the JE log or JE replication messages.
 * <p>
 * Classes that implement {@code Loggable} and are included in replication data
 * should implement {@code VersionedWriteLoggable}.
 */
public interface Loggable {
    ...
    /**
     * @return true if these two loggable items are logically the same. Used for
     *         replication testing.
     */
