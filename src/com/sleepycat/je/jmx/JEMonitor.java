 ...
 * property JEMonitor is set. It only works on an active JE Environment, and an
 * Environment can only register one instance of JEMonitor.
 *
 * @see <a href="{@docRoot}/../jconsole/JConsole-plugin.html">Monitoring JE with
 *      JConsole and JMX</a>
 */
public class JEMonitor extends JEMBean implements DynamicMBean {
    ...
    private static final MBeanAttributeInfo[] COMMON_ATTR          = {
            ...
            new MBeanAttributeInfo(ATT_ENV_HOME, "java.lang.String", "Environment home directory.", true, false,
                    false) };
    ...
    private static final MBeanAttributeInfo[] OPEN_ATTR            = {
            ...
            new MBeanAttributeInfo(ATT_IS_TRANSACTIONAL, "java.lang.Boolean",
                    "true if this Environment supports transactions.", true, false, true),

            new MBeanAttributeInfo(ATT_CACHE_SIZE, "java.lang.Long", "Cache size, in bytes.", true, true, false),
            ...
            new MBeanAttributeInfo(ATT_LOCK_TIMEOUT, "java.lang.Long", "Lock timeout, in microseconds.", true, false,
                    false) };
    ...
    private static final MBeanAttributeInfo[] TRANSACTIONAL_ATTR   = {
            ...
            new MBeanAttributeInfo(ATT_TXN_TIMEOUT, "java.lang.Long",
                    "Transaction timeout, in seconds. A value of 0 means there is " + "no timeout.", true, false,
                    false) };
    ...
    private static final MBeanOperationInfo   OP_CLEAN_INFO        = new MBeanOperationInfo(OP_CLEAN,
            ...
            new MBeanParameterInfo[0], "java.lang.Integer", MBeanOperationInfo.UNKNOWN);
    ...
    private static final MBeanOperationInfo   OP_SYNC_INFO         = new MBeanOperationInfo(OP_SYNC,
            "Flush the environment to stable storage.", new MBeanParameterInfo[0], "void", MBeanOperationInfo.UNKNOWN);
    ...
    private static final MBeanOperationInfo   OP_DB_NAMES_INFO     = new MBeanOperationInfo(OP_DB_NAMES,
            "Get the names of databases in the environment.", new MBeanParameterInfo[0], "java.util.ArrayList",
    ...
    private static final MBeanOperationInfo   OP_ENV_CONFIG_INFO   = new MBeanOperationInfo(OP_ENV_CONFIG,
            "Get environment configuration.", new MBeanParameterInfo[0], "java.lang.String", MBeanOperationInfo.INFO);
