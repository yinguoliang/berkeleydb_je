...
public interface DataChannelFactory {
     ...
     * @return an implementation of DataChannel that wraps the input
     *         SocketChannel
     */
    ...
    public class ConnectOptions {
        ...
        /**
         * Creates a base set of connection options. The default values for the
         * options are:
         * 
         * <pre>
         *   tcpNoDelay = false
         ...
         *
         * @param rcvBufferSize the desired size of the receive buffer, or 0 to
         *            use system defaults.
         * @return this instance
         */
         ...
         *
         * @param timeout the desired timeout value for connection initiation in
        ...
        public String toString() {
            return "ConnectOptions[" + "tcpNoDelay = " + tcpNoDelay + ", receiveBufferSize = " + receiveBufferSize
                    + ", openTimeout = " + openTimeout + ", readTimeout = " + readTimeout + ", blocking = " + blocking
                    + ", reuseAddr = " + reuseAddr + "]";
        }
    };

    /**
     * Creates a DataChannel that connects to the specified address, with the
     * specified options.
     *
     * @param addr The address to which the connection should be made. It is
     *            possible for a DataChannelFactory implementation to proxy this
     *            connection through an intermediary.
     * @param connectOptions the collection of connection options to be applied
     *            to the connection.
