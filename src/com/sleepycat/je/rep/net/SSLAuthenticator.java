 ...
 * Implementations of this interface can be configured for use by the HA service
 * to determine whether a client connection should be treated as authenticated.
 */
