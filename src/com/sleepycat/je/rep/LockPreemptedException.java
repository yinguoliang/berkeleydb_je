 ...
 * <p>
 * The {@link com.sleepycat.je.Transaction} handle is invalidated as a result of
 * this exception.
 * </p>
 * <p>
 * Locks may be preempted in a JE HA environment on a Replica system when the HA
 * write operation needs a lock that an application reader transaction or cursor
 * holds. This exception is thrown by a reader transaction or cursor method that
 * is called after a lock has been preempted.
 * </p>
 * <p>
