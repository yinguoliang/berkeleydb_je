 ...
 * <p>
 * {@link NodeState} provides information about the current state of a member of
 * the replication group. The application can obtain NodeState via
 * {@link com.sleepycat.je.rep.util.ReplicationGroupAdmin#getNodeState} or
 * {@link com.sleepycat.je.rep.util.DbPing#getNodeState}. A NodeState contains
 * mostly JE-centric information, such as whether the node is a master or
 ...
 * {@link ReplicatedEnvironment#registerAppStateMonitor(AppStateMonitor)}. There
 * is at most one AppStateMonitor associated with the actual environment (not an
 * {@link com.sleepycat.je.Environment} handle) at any given time. JE HA calls
 * {@link AppStateMonitor#getAppState} when it is assembling status information
 * for a given node.
 * <p>
