...
/**
 * @hidden SSL deferred This is the root class for specifying the parameters
 *         that control replication network communication within a a replicated
 ...
 *         </li>
 *         <li>Configuration parameters set in the ReplicationNetworkConfig
 *         object used at {@code ReplicatedEnvironment} construction are next.
 *         </li>
...
public abstract class ReplicationNetworkConfig implements Cloneable, Serializable {
    ...
    /*
     * The following is currently undocumented: The channelType property may
     * also take the value: <code>custom</code> <code>custom</code> indicates
     * that the channel implementation is to be provided by the application.
     * This can be done through the use of the combination of two configuration
     * parameters <pre> {@link #CHANNEL_FACTORY_CLASS
     * je.rep.channelFactoryClass} {@link #CHANNEL_FACTORY_PARAMS
     * je.rep.channelFactoryParams} </pre>
     */

    /**
     * Configures the type of communication channel to use. This property is not
     * directly setable. It can be specified in a property file or property set
     * passed to a create() method, or a direct instantiation of a class derived
     * from this class may be used. When set through one of the create() methods
     * or when read through the getChannelType() method, the valid values for
     * this parameter are:
     * <ul>
     ...
     *         parameter, but this allows a custom data channel factory to be
     *         supplied. If supplied, it must be a fully qualified Java class
     *         name for a class that implements the {@link DataChannelFactory}
     *         interface and provides a public constructor with an argument list
     *         of the form ( {@link InstanceParams} )
     *         <p>
     *         Note: Setting this class instantiated from this parameter must be
     *         of the same configuration type as indicated by channelType().
     *         <p>
     *         <table border="1">
     *         <tr>
     *         <td>Name</td>
     ...
     *         </p>
     */
    public static final String CHANNEL_FACTORY_CLASS  = EnvironmentParams.REP_PARAM_PREFIX + "channelFactoryClass";

    /**
     * @hidden A string providing factory-specific data channel configuration
     *         parameters. The encoding of parameters within the string is
     *         determined by the specific factory class implementation. As
     *         examples, it may choose to join multiple strings with a delimiter
     *         character or may allow binary data to be hex-encoded. Note:
     *         Setting this parameter is ignored unless {@link #CHANNEL_TYPE
     ...
     *         </p>
     */
    public static final String CHANNEL_FACTORY_PARAMS = EnvironmentParams.REP_PARAM_PREFIX + "channelFactoryParams";
     ...
     * </p>
     */
    public static final String CHANNEL_LOG_NAME       = EnvironmentParams.REP_PARAM_PREFIX + "channelLogName";
    ...
    /*
     * The set of Replication properties for this class and derived classes. It
     * is created later, no demand, to deal with class loading ordering
     */
     ...
     *
     * @param propFile a File from which the configuration properties will be
     *            read.
     * @return an instance of a class derived from ReplicationNetworkConfig as
     *         indicated by the channelType property.
     ...
     *
     * @return an instance of a class derived from ReplicationNetworkConfig as
     *         indicated by the channelType property default.
     */
    ...
    /**
     * Constructs a basic ReplicationNetworkConfig initialized with the provided
     * propeties.
     * 
    ...
    /**
     * @hidden Returns name of the DataChannel factory class to be used for
     *         creating new DataChannel instances
    ...
    /**
     * @hidden Sets the name of the DataChannelFactory class to be instantiated
     *         for creation of new DataChannel instances.
    ...
    /**
     * @hidden Returns the DataChannelFactory class parameters to be used for
     *         when instantiating the DataChannelFactoryClass
    ...
    /**
     * @hidden Sets the DataChannelFactory parameters to be passed when
     *         instantiating the DataChannelFactoryClass.
     * @param factoryParams a string encoding any parameters to be passed to the
     *            class constructor.
     * @return this
     */
     ...
     *             if paramName is not a parameter that applies to
     ...
     *         intended to control network access that are specific to this
     *         class.
     */
    ...
    /**
     * @hidden Ensure that the parameters for this and all known derived classes
     *         are registered. This is called by testing code to ensure that
     *         parameter registration happens when non-standard API access is
     *         used.
     */
    ...
    /**
     * @hidden Apply the configurations specified in sourceProps to our
     *         properties.
     * @throws IllegalArgumentException if any of the contained property entries
     *             have invalid names or invalid values
     */
     ...
     *         effectively copying the replication service access properties
     *         from the sourceProps hash. Only the source properties that are
     *         applicable to a ReplicationNetworkConfig are used.
     * @throws IllegalArgumentException if any of the contained property entries
     *             have invalid values
     */
     ...
     * Properties object, which is assumed to represent the properties that are
     * applicable to this class. Values are validated before setting the
     * parameter.
     *
     ...
     */
    private static void setConfigParam(Properties props, String paramName, String value, boolean validateParams)
            throws IllegalArgumentException {
