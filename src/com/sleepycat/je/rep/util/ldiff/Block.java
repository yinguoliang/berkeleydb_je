...
public class Block implements java.io.Serializable {
    ...
    /*
     * For debugging support and to minimize the actual data that is transferred
     * over the network, I store the beginKey and endKey as the index to each of
     * the block. TODO to optimize: replace the {beginKey, endKey} by something
     * like LSN.
     */
    ...
    public boolean equals(Object o) {
        ...
        return (this.blockId == other.blockId) && (this.numRecords == other.numRecords)
                && Arrays.equals(this.beginKey, other.beginKey) && Arrays.equals(this.beginData, other.beginData)
                && (this.rollingChksum == other.rollingChksum) && Arrays.equals(this.md5Hash, other.md5Hash);
    }

    @Override
    public String toString() {
        final Formatter fmt = new Formatter();
        fmt.format("Block %d: rollingChksum=%x md5Hash=%s numRecords=%d", blockId, rollingChksum,
                Arrays.toString(md5Hash), numRecords);
        return fmt.toString();
    }
}
