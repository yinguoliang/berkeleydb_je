...
public class LDiffConfig {
     ...
     * failures.
     *
     * @return true if an LDiff object will provide detailed analysis about diff
     *         failures.
     */
    ...
    /**
     * Configure whether or not the operation should wait for the remote service
     * to become available, if the remote service is busy.
     *
     * @param wait if true, the LDiff operation will block until the remote node
     *            is available
     * @param maxAttempts the number of times to attempt connecting to the
     *            service before aborting. Pass -1 to never abort.
     ...
     * success or failure.
     *
     * @param verbose if true, the LDiff operation will output information as it
     *            compares databases
     */
