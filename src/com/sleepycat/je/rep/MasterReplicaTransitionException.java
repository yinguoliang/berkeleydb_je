 ...
 * replication systems when an environment that was a master and transitioned to
 * replica state. In some cases, the environment had to reinitialize internal
 * state to become a replica, and the application was required to the
 * application close and reopen its environment handle, thereby properly
