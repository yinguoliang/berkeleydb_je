 ...
 * this node gives an indication of how current this node's data is. The gap in
 * VLSN values indicates the number of replication records that must be
 ...
 * <li>The appState field is a byte array meant to hold information generated by
 * the JE HA application, as provided by a registered
 * {@link com.sleepycat.je.rep.AppStateMonitor}. Users are responsible for
 * serializing and deserializing information for this field.</li>
 * </ul>
 * 
 * @since 5.0
 */
public class NodeState {
     ...
     */
    public NodeState(String nodeName, String groupName, State currentState, String masterName, JEVersion jeVersion,
                     long joinTime, long currentTxnEndVLSN, long masterTxnEndVLSN, int activeFeeders, int logVersion,
                     byte[] appState, double systemLoad) {
    ...
    /**
     * Returns the replication {@link ReplicatedEnvironment.State state} of this
     * node.
     *
    ...
    /**
     * Returns the name of the current {@link State#MASTER master} known by this
     * node.
     *
