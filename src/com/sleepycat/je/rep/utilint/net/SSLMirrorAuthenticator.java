...
/**
 * This is an implementation of SSLAuthenticator that authenticates based on the
 * certificate of the client matching the certificate that we would use when
...
public class SSLMirrorAuthenticator extends SSLMirrorMatcher implements SSLAuthenticator {
    ...
    /*
     * Checks whether the peer should be trusted based on the information in the
     * SSLSession object. This should be called only after the SSL handshake has
     * completed.
     */
    @Override
