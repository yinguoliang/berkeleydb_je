 ...
 * using Java regular expressions against the RFC1779 normalized DN. This may be
 * used to match against the complete DN or just a portion, such as the CN
 * portion.
 */
...
public class SSLDNAuthenticator extends SSLDNMatcher implements SSLAuthenticator {
    ...
    /*
     * Based on the information in the SSLSession object, should the peer be
     * trusted as an internal entity? This should be called only after The SSL
