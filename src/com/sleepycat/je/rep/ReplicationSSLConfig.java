...
/**
 * @hidden SSL deferred Specifies the parameters that control replication
 *         network communication within a replicated environment using SSL. The
 *         parameters contained here are immutable.
 *         <p>
 *         To change the default settings for a replicated environment, an
 *         application creates a configuration object, customizes settings and
 *         uses it for {@link ReplicatedEnvironment} construction. Except as
 *         noted, the set methods of this class perform only minimal validation
 *         of configuration values when the method is called, and value checking
 *         is deferred until the time a DataChannel factory is constructed. An
 ...
 *         {@literal <environmentHome>/je.properties} take first precedence.
 *         </li>
 *         <li>Configuration parameters set in the ReplicationSSLConfig object
 *         used at {@code ReplicatedEnvironment} construction are next.</li>
 *         <li>Any configuration parameters not set by the application are set
 *         to system defaults, described along with the parameter name String
...
public class ReplicationSSLConfig extends ReplicationNetworkConfig {
    ...
    /**
     * Configures the type of communication channel to use. Valid values for
     * this parameter are:
     * <ul>
     * <li><code>ssl</code></li>
     * </ul>
     ...
     * {@link #setSSLKeyStorePasswordSource} {@link #SSL_KEYSTORE_PASSWORD_CLASS
     * je.rep.ssl.keyStorePasswordClass} {@link #setSSLKeyStorePassword}
     * {@link #SSL_KEYSTORE_PASSWORD je.rep.ssl.keyStorePassword} The
     * <code>javax.net.ssl.keyStorePassword</code> system property The
     * properties supported by the supplied SSL channel factory are:
     * 
     * <pre>
    ...
    /**
     * The path to the Java keystore file for SSL data channnel factories. The
     * specified path must be absolute. If this parameter is not set or has an
     * empty value, the Java system property <code>javax.net.ssl.keyStore</code>
     * is used.
     * <p>
     * <table border="1">
     * <tr>
     ...
     * </p>
     */
    public static final String SSL_KEYSTORE_FILE            = EnvironmentParams.REP_PARAM_PREFIX + "ssl.keyStoreFile";
     ...
     * </p>
     */
    public static final String SSL_KEYSTORE_PASSWORD        = EnvironmentParams.REP_PARAM_PREFIX
     ...
     * </p>
     */
    public static final String SSL_KEYSTORE_PASSWORD_CLASS  = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.keyStorePasswordClass";
     ...
     * </p>
     */
    public static final String SSL_KEYSTORE_PASSWORD_PARAMS = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.keyStorePasswordParams";

    /**
     * The type of the Java keystore file. This is used to determine what
     * keystore implementation should be used to manipulate the named keystore
     * file. If set to a non-empty value, the value must be a valid keystore
     * type for the Java environment. If this parameter is not set to a
     ...
     * </p>
     */
    public static final String SSL_KEYSTORE_TYPE            = EnvironmentParams.REP_PARAM_PREFIX + "ssl.keyStoreType";
     ...
     * </p>
     */
    public static final String SSL_SERVER_KEY_ALIAS         = EnvironmentParams.REP_PARAM_PREFIX + "ssl.serverKeyAlias";

    /**
     * The alias name of the preferred key for use by a client connecting to the
     * service dispatcher. When not set to a non-empty value and the keystore
     * contains multiple key options, the key selection algorithm is
     * unspecified.
     * <p>
     * <table border="1">
     * <tr>
     ...
     * </p>
     */
    public static final String SSL_CLIENT_KEY_ALIAS         = EnvironmentParams.REP_PARAM_PREFIX + "ssl.clientKeyAlias";

    /**
     * The path to the Java truststore file for SSL data channel factories. The
     * specified path must be absolute. If this parameter is not set to a
     * non-empty value, the Java system property
     * <code>javax.net.ssl.trustStore</code> is used.
     * <p>
     * <table border="1">
     * <tr>
     * <td>Name</td>
     ...
     * </p>
     */
    public static final String SSL_TRUSTSTORE_FILE          = EnvironmentParams.REP_PARAM_PREFIX + "ssl.trustStoreFile";
     ...
     * </p>
     */
    public static final String SSL_TRUSTSTORE_TYPE          = EnvironmentParams.REP_PARAM_PREFIX + "ssl.trustStoreType";

    /**
     * The list of SSL cipher suites that are acceptable for SSL data channel
     * factories. The cipher suite list must be in comma-delimited form. If this
     * parameter is not set to a non-empty value, the Java default set of
     * enabled cipher suites is allowed.
     * <p>
     * <table border="1">
     * <tr>
     * <td>Name</td>
     ...
     * </p>
     */
    public static final String SSL_CIPHER_SUITES            = EnvironmentParams.REP_PARAM_PREFIX + "ssl.cipherSuites";

    /**
     * The list of SSL protocols that are acceptable for SSL data channel
     * factories. The protocol list must be in comma-delimited form. If not
     * specified, the default type selected is TBD: TLSv1.
     * <p>
     * <table border="1">
     * <tr>
     * <td>Name</td>
    ...
    /**
     * The specification for an SSL authenicator. The authenticator can be
     ...
     * when connecting as a client to another server. The <code>dnmatch()</code>
     * option causes the authenticator to check that the DN in the certificate
     * of the incoming client connection matches the regular expression provided
     * in the dnmatch() specification. Do not configure both the SSL
     * authenticator and the SSL authenticator class, or an exception will be
     * thrown during DataChannelFactory instantiation.
     * <p>
     * <table border="1">
     * <tr>
     * <td>Name</td>
     ...
     * </p>
     */
    public static final String SSL_AUTHENTICATOR            = EnvironmentParams.REP_PARAM_PREFIX + "ssl.authenticator";
     ...
     * implements the {@link SSLAuthenticator} interface and provides a public
     ...
     * </p>
     */
    public static final String SSL_AUTHENTICATOR_CLASS      = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.authenticatorClass";
     ...
     * </p>
     */
    public static final String SSL_AUTHENTICATOR_PARAMS     = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.authenticatorParams";

    /**
     * The configuration to be used for verifying the certificate of a server
     * when a connection is made. The verifier can be configured in one of the
     * following ways:
     * <ul>
     ...
     * certificate presented by the server contains the hostname that was the
     * target of the connection attempt. This assumes that server certificates
     * are unique per server.
     * <p>
     * The <code>mirror</code> option causes the verifier to check that the
     * Distinguished Name(DN) in the certificate of the server matches the DN of
     * the certificate that this server presents to incoming client connections.
     * This assumes that all servers have equivalent certificates.
     * <p>
     * The <code>dnmatch()</code> option causes the verifier to check that the
     * DN in the certificate of the server matches the regular expression string
     * provided in the dnmatch() specification.
     * <p>
     ...
     * </p>
     */
    public static final String SSL_HOST_VERIFIER            = EnvironmentParams.REP_PARAM_PREFIX + "ssl.hostVerifier";
     ...
     * string must be a fully qualified Java class name for a class that
     * implements the <code>javax.net.ssl.HostnameVerifier</code> interface and
     ...
     * </p>
     */
    public static final String SSL_HOST_VERIFIER_CLASS      = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.hostVerifierClass";

    /**
     * A string encoding the parameters for configuring the host verifier class,
     * if needed.
     * <p>
     * <table border="1">
     * <tr>
     ...
     * </p>
     */
    public static final String SSL_HOST_VERIFIER_PARAMS     = EnvironmentParams.REP_PARAM_PREFIX
            + "ssl.hostVerifierParams";
    ...
    /**
     * Creates an ReplicationSSLConfig which includes the properties specified
    ...
    /**
     * Sets the name of the Java KeyStore file to be used when creating SSL
     * connections.
     *
    ...
    /**
     * Sets the type of the Java KeyStore file to be used when creating SSL
     * connections.
     *
    ...
    /**
     * Sets the password for the Java KeyStore file to be used when creating SSL
     * connections.
     *
    ...
    /**
     * Sets the name of the Java TrustStore file to be used when validating SSL
     * certificates.
     *
    ...
    /**
     * Sets the type of the Java Truststore file to be used when creating SSL
     * connections.
     *
     ...
     * incoming client connections. See {@link #SSL_AUTHENTICATOR} for a
     * complete description of this parameter.
     *
     * @param authenticator the authentication configuration to use
     * @return this
     * @throws IllegalArgumentException if the authenticator specification is
    ...
    /**
     * Returns the SSLAuthenticator factory class to be used for creating new
    ...
    /**
     * Sets the authenticator class to be instantiated for creation of new SSL
     * Authenticator instances.
     *
    ...
    public void setSSLAuthenticatorClassVoid(String authenticatorClass) throws IllegalArgumentException {
        ...
        DbConfigManager.setVal(props, RepParams.SSL_AUTHENTICATOR_CLASS, authenticatorClass, validateParams);
    }

    /**
     * Returns the SSLAuthenticator parameters to be used for creating new
     * Authenticator instances
     *
    ...
    /**
     * Sets the Authenticator parameters to be passed to the SSL server
     * Authenticator class when instantiated.
     *
    ...
    public void setSSLAuthenticatorParamsVoid(String authenticatorParams) {
        ...
        DbConfigManager.setVal(props, RepParams.SSL_AUTHENTICATOR_PARAMS, authenticatorParams, validateParams);
    }

    /**
     * Returns the HostnameVerifier factory class to be used for creating new
     * host verifier instances for client-mode operation
     *
    ...
    /**
     * Sets the configuration to be used for verifying the certificate of a
     * server when a connection is made. See {@link #SSL_HOST_VERIFIER} for a
     * complete description of this parameter.
     *
    ...
    /**
     * Sets the host verifier class to be instantiated for creation of new SSL
     * host verifier instances.
     *
    ...
    public void setSSLHostVerifierClassVoid(String hostVerifierClass) {
        ...
        DbConfigManager.setVal(props, RepParams.SSL_HOST_VERIFIER_CLASS, hostVerifierClass, validateParams);
    }

    /**
     * Returns the SSLHostVerifier parameters to be used for creating new host
     * verifier instances for operation in client mode, if needed.
     *
    ...
    public void setSSLHostVerifierParamsVoid(String hostVerifierParams) {
        ...
        DbConfigManager.setVal(props, RepParams.SSL_HOST_VERIFIER_PARAMS, hostVerifierParams, validateParams);
    }
     ...
     * {@link #SSL_KEYSTORE_PASSWORD je.rep.ssl.keyStorePassword} property
     * instead. This setting is not included in the serialized representation.
     */
