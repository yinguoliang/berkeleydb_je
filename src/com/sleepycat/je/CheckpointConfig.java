...
public class CheckpointConfig implements Cloneable {
     ...
     * </p>
     *
     * @param kBytes If the kBytes parameter is non-zero, a checkpoint will be
     ...
     *            take longer but will cause a subsequent recovery
     *            (Environment.open) to finish more quickly.
     * @return this
     */
