 ...
 * {@link com.sleepycat.je.Environment#checkpoint Environment.checkpoint}.
 */
public class CheckpointConfig implements Cloneable {
	 ...
	 *
	 * @param kBytes
	 *            If the kBytes parameter is non-zero, a checkpoint will be
	 *            performed if more than kBytes of log data have been written
	 ...
	 *            If set to true, the checkpoint will itself take longer but
	 *            will cause a subsequent recovery (Environment.open) to finish
	 *            more quickly.
	 *
	 * @return this
	 */
