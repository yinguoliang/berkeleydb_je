...
public class PreloadStats implements Serializable {
	...
	/**
	 * @deprecated returns zero for data written using JE 5.0 and later, but may
	 *             return non-zero values when reading older data.
	 */
	 ...
	 * specified by {@link com.sleepycat.je.PreloadConfig#setInternalMemoryLimit
