 ...
 * <p>
 * This exception normally indicates that a transaction may be retried. Catching
 * this exception, rather than its subclasses, is convenient and recommended for
 * handling lock conflicts and performing transaction retries in a general
 * purpose manner. See below for information on performing transaction retries.
 * </p>
 * <p>
 * The exception carries two arrays of transaction ids, one of the owners and
 * the other of the waiters, at the time of the lock conflict. This information
 * may be used along with the {@link Transaction#getId Transaction ID} for
 * diagnosing locking problems. See {@link #getOwnerTxnIds} and
 * {@link #getWaiterTxnIds}.
 * </p>
 * <p>
 * The {@link Transaction} handle is invalidated as a result of this exception.
 * </p>
 * <a name="retries">
 * <h3>Performing Transaction Retries</h3></a>
 * <p>
 * If a lock conflict occurs during a transaction, the transaction may be
 * retried by performing the following steps. Some applications may also wish to
 * sleep for a short interval before retrying, to give other concurrent
 * transactions a chance to finish and release their locks.
 * </p>
 * <ol>
 ...
 * </ol>
 * <p>
 * To handle {@link LockConflictException} reliably for all types of JE
 ...
 * </pre>
 * <p>
 * For more information on transactions and lock conflicts, see <a href=
...
public abstract class LockConflictException extends OperationFailureException {
    ...
    /**
     * Returns an array of longs containing transaction ids of owners at the the
     * time of the timeout.
     *
     * @return an array of longs containing transaction ids of owners at the the
     *         time of the timeout.
     */
