...
public class EnvironmentFailureException extends RunRecoveryException {
	 ...
	 *
	 *         If the cause is not an EnvironmentFailureException, wraps the
	 *         cause exception in an EnvironmentFailureException along with the
	 *         message. If the cause is an EnvironmentFailureException, adds the
	 *         message to it.
	 *
	 ...
	 * @hidden
	 *
	 * 		Creates an exception indicating that an unexpected exception was
	 ...
	 * @hidden
	 *
	 * 		Creates an exception indicating that unexpected internal state
	 ...
	 * @hidden
	 *
	 * 		Convenience method that throws an UNEXPECTED_STATE exception
