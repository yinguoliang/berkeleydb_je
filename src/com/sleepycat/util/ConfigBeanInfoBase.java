...
public class ConfigBeanInfoBase extends SimpleBeanInfo {
    ...
    /*
     * Get the propertis' infomation, including all the properties's names and
            ...
            for (int i = 0; i < allMethodNames.size(); i++) {
                ...
                if (subName.equals("set")) {
                    ...
                    if (getterMethod != null) {
                        ...
                        /*
                         * Add the real property name into propertiesName. if
                         * the names of setter/getter methods are setFoo/getFoo,
                         * the name of the property should be "foo".
                         */
                        propertiesName.add(propertyName.substring(0, 1).toLowerCase() + propertyName.substring(1));
                    }
                }
            }
    ...
    protected static PropertyDescriptor[] getPdescriptor(Class cls) {
        ...
        try {
            for (int i = 0, j = 0; i < propertyNum; i += 1, j += 2) {
                properties[i] = new PropertyDescriptor(propertiesName.get(i), cls, getterAndSetterMethods.get(j),
