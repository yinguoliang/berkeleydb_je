...
public class ClassLoaderTest extends DualTestCase {
    ...
    private static final String LOADED_CLASS_IMPL = "com.sleepycat.je.LoadedClassImpl";
    ...
    public void setUp() throws Exception {
        ...
        final Class cls = Class.forName(LOADED_CLASS_IMPL, true /* initialize */, myLoader);
    ...
    abstract class WithThreadLoader {
        ...
        void exec() {
            final ClassLoader save = Thread.currentThread().getContextClassLoader();
    ...
    @Test
    public void testDbComparatorWithThreadLoader() throws Exception {
    ...
    @Test
    public void testDbComparatorWithEnvLoader() throws Exception {
    ...
    private Database openDbWithComparator(boolean cmpByClass) {
        ...
        if (cmpByClass) {
            dbConfig.setBtreeComparator(loadedClass.getReverseComparatorClass());
            dbConfig.setDuplicateComparator(loadedClass.getReverseComparatorClass());
        } else {
            dbConfig.setBtreeComparator(loadedClass.getReverseComparator());
            dbConfig.setDuplicateComparator(loadedClass.getReverseComparator());
        }
        final String name = "testDB" + (cmpByClass ? "CmpByClass" : "CmpByInstance");
    ...
    private void readReverseOrder(Database db) {
        ...
        for (int i = 5; i >= 1; i -= 1) {
            assertSame(OperationStatus.SUCCESS, c.getNextNoDup(key, data, LockMode.DEFAULT));
            assertEquals(i, IntegerBinding.entryToInt(key));
        }
        assertSame(OperationStatus.NOTFOUND, c.getNextNoDup(key, data, LockMode.DEFAULT));

        /* Read dups. */
        assertSame(OperationStatus.SUCCESS, c.getFirst(key, data, LockMode.DEFAULT));
    ...
    @Test
    public void testSerialBindingWithThreadLoader() throws Exception {
    ...
    @Test
    public void testSerialBindingWithEnvLoader() throws Exception {
    ...
    @Test
    public void testDPLWithThreadLoader() throws Exception {
    ...
    @Test
    public void testDPLWithEnvLoader() throws Exception {
