...
/**
 * The split aunt problem [#14424] is described in LevelRecorder. Also see
 * [#23990] and [#24663].
 */
public class CheckSplitAuntTest extends CheckBase {
    ...
    @Test
    public void testSplitAunt() throws Throwable {
    ...
    private void setupSplitData(Database db) throws DatabaseException {
        ...
        assertEquals(OperationStatus.SUCCESS, db.put(null, key, data));
        Trace.trace(DbInternal.getNonNullEnvImpl(env), "After single key insert");

        /*
         * A normal checkpoint should log the BIN and its parent IN, but no
         * higher than level 2. The level 3 parent will be left dirty, but level
         * 4 (the root) will not be dirtied.
         */
