...
public class SerializeWriteObjects {
    ...
    /*
     * If the directory doesn't exist, create a new one; Or delete it and make a
     * fresh one.
     */
    ...
    public void writeObjects() throws IOException {
        ...
        for (Map.Entry<String, Object> entry : SerializeUtils.getSerializedSet().entrySet()) {
            out = new ObjectOutputStream(new FileOutputStream(outputDir.getPath() + System.getProperty("file.separator")
    ...
    public static void main(String args[]) throws IOException {
        ...
        String dirName = args[0] + System.getProperty("file.separator") + JEVersion.CURRENT_VERSION.toString();
