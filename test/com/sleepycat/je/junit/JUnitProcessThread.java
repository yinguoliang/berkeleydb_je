 ...
 * Write this thread for creating multi-process test, you can generate a
 * JUnitProcessThread, each thread would create a process for you, just need to
 * assign the command line parameters to the thread.
 */
public class JUnitProcessThread extends JUnitThread {
    ...
    public JUnitProcessThread(String threadName, int heapMB, String[] jvmParams, String[] parameters) {
    ...
    public JUnitProcessThread(String threadName, int heapMB, String[] jvmParams, String[] parameters,
        ...
        cmd.add(System.getProperty("java.home") + System.getProperty("file.separator") + "bin"
        ...
        cmd.add("-cp");
        cmd.add("." + System.getProperty("path.separator") + System.getProperty("java.class.path"));
