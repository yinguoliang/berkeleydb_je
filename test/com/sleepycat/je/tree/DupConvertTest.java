...
public class DupConvertTest extends TestBase {
    ...
    private final String         DeletedLNNoCommit_jdb   = "je-4.1.7_logWithDeletedLNNoCommit.jdb";
    ...
    private void openEnv(String logName, boolean readOnly, boolean loadLog) throws DatabaseException, IOException {
    ...
    @Test
    public void testLogWithSingletonLN() throws DatabaseException, IOException {
    ...
    @Test
    public void testLogWithDIN() throws DatabaseException, IOException {
    ...
    @Test
    public void testLogWithDeleteLNCommit() throws DatabaseException, IOException {
    ...
    @Test
    public void testLogWithDeleteLNNoCommit() throws DatabaseException, IOException {
    ...
    @Test
    public void testLogWithMixIN() throws DatabaseException, IOException {
    ...
    /**
     * Open a log with DBINs/DINs in the last checkpoint. The preupgrade utility
     * was not run, so an exception should be thrown when opening this
     * environment with JE 5.
     */
    @Test
    public void testNoPreUpgradeDups() throws IOException {
    ...
    /**
     * Open a log with deltas in the last checkpoint. The preupgrade utility was
     * not run, so an exception should be thrown when opening this environment
     * with JE 5.
     */
    @Test
    public void testNoPreUpgradeDeltas() throws IOException {
