...
public class FileManagerTest extends TestBase {
    ...
    public void setUp() throws Exception {
        ...
        /*
         * The following TestUtils.removeFiles will delete files manually, so
         * for this series of tests, we disable log file deletion detect.
         */
    ...
    public void testLsnBumping() throws Exception {
        ...
        /*
         * We are adding these entries: +----+------+---------+--------+ file 0:
         * |hdr | 30 | 50 |empty | +----+------+---------+--------+ 0 hdr hdr+30
         * hdr+80 99 +----+--------+-------+-------+-----+-------+ file 1: |hdr
         * | 40 | 20 | 10 | 5 | empty |
         * +----+--------+-------+-------+-----+-------+ 0 hdr hdr+40 hdr+60
         * hdr+70 hdr+75 +-----+-----+--------+ file 2: | hdr | 75 | empty |
         * +-----+-----+--------+ 0 hdr hdr+75
         * +-----+-------------------------------+ file 3: | hdr | 125 |
         * +-----+-------------------------------+ 0 hdr
         * +-----+-----+------+-----+--------------+ file 4: | hdr | 10 | 20 |
         * 30 | empty +-----+-----+------+-----+--------------+ 0 hdr hdr+10
         * hdr+30
         */
    ...
    public void testSetLastPosition() {
        ...
        assertEquals(DbLsn.makeLsn(80L, FileManager.firstLogEntryOffset()), fileManager.getLastUsedLsn());
        assertEquals(0, fileManager.getPrevEntryOffset());
    }
    ...
    public void testFileNameFormat() {
        ...
        assertEquals(filePrefix + "00000001.jdb", fileManager.getFullFileNames(1L)[0]);
        assertEquals(filePrefix + "0000007b.jdb", fileManager.getFullFileNames(123L)[0]);
    }
     ...
     */
    @Test
    public void testFileCreation() throws ChecksumException, IOException, DatabaseException {
     ...
     */
    @Test
    public void testLastFile() throws IOException, DatabaseException {
        ...
        assertEquals("Should have 2 as last file", 2L, fileManager.getLastFileNum().longValue());
        fakeFile1.delete();
    }
     ...
     */
    @Test
    public void testFollowingFile() throws IOException {
        ...
        /* Test forward */
        assertEquals("Should get 6 next", 6L, fileManager.getFollowingFileNum(2, true).longValue());
        assertEquals("Should get 9 next, testing non-existent file", 9L,
                fileManager.getFollowingFileNum(8, true).longValue());
        assertNull("Should get null next", fileManager.getFollowingFileNum(9, true));
        assertNull("Should get null next", fileManager.getFollowingFileNum(10, true));

        /* Test prev */
        assertEquals("Should get 6 next, testing non-existent file", 6L,
                fileManager.getFollowingFileNum(8, false).longValue());
        assertEquals("Should get 6 next", 6L, fileManager.getFollowingFileNum(9, false).longValue());
        assertNull("Should get null next", fileManager.getFollowingFileNum(1, false));
        assertNull("Should get null next", fileManager.getFollowingFileNum(0, false));
    ...
    public void testBadHeader() throws IOException, DatabaseException {
        ...
        RandomAccessFile file0 = new RandomAccessFile(fileManager.getFullFileName(0, FileManager.JE_SUFFIX),
    ...
    public void testCache() throws Throwable {
        ...
        try {
            ...
            /*
             * Ask for a fourth handle, the cache should grow even though it was
             * set to 3 as a starting size, because all handles are locked. Do
             * it within another thread, otherwise we'll get a
    ...
    public void testFlipFile() throws Throwable {
         ...
         * file range twice in FileManager.lockEnvironment, so we must close the
         * standalone FileManager here before opening a regular environment.
         */
        fileManager.clear();
        fileManager.close();
        fileManager = null;
