...
public class DbConfigManagerTest extends TestBase {
    ...
    /**
     * Test that parameter defaults work, that we can add and get parameters
     */
    @Test
    public void testBasicParams() {
        ...
        /**
         * Longs: The config manager should return the value for an explicitly
         * set param and the default for one not set.
         */
        assertEquals(2000, configManager.getLong(EnvironmentParams.MAX_MEMORY));
        assertEquals(EnvironmentParams.ENV_RECOVERY.getDefault(), configManager.get(EnvironmentParams.ENV_RECOVERY));
    }
    ...
    public void testBooleanWhitespace() {
        ...
        BooleanConfigParam param = (BooleanConfigParam) EnvironmentParams.SUPPORTED_PARAMS.get(name);
